"""본회의활동 게시판(plenary) → plenary_activities.

컬럼: 번호·제목·작성자·작성일·첨부파일·조회수 (대수/회차 컬럼 없음).
...
SPEC = BoardSpec(
    name="plenary",
    bbs_id=config.BBS["plenary"],
    table="plenary_activities",
    classify=_classify,
    to_record=_to_record,
    update_cols=["term", "session_round", "title", "posted_date",
